...
set "built_whisper_bin=%build_dir%\bin\whisper-cli.exe"
set "built_whisper_release_bin=%build_dir%\bin\Release\whisper-cli.exe"
...
"%cmake_exe%" --build "%build_dir%" --target whisper-cli --parallel %jobs%
if errorlevel 1 exit /b %errorlevel%
